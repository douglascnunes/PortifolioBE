...
export default function AdminPage() {
  ...
  switch (view) {
    ...
    case 'curriculum':
      ...
      break;
    case 'studies':
      content = <h2>Estudos</h2>;
      title = 'Estudos';
      break;
    case 'works':
      content = <h2>Experiência Profissional</h2>;
    ...
    case 'blog':
      ...
      break;
    default:
      content = <h2>Bem-vindo ao Painel Administrativo</h2>;
      title = 'Dashboard';
  }
  ...
  return (
    <div className={styles.container}>
      <aside className={styles.sidebar}>
        <Button type="vlist" onClick={() => setView('recommendations')}>
        ...
        <Button type="vlist" onClick={() => setView('curriculum')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('studies')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('works')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('techs')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('abilities')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('users')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('projects')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Button type="vlist" onClick={() => setView('blog')}>
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
