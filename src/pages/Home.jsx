...
import { getActiveCurriculum } from '../api/curriculum';
import RecommendationCarossel from '../components/home/recommendationCarossel/RecommendationCarossel';
...
function HomePage() {
  ...
  async function handleDownloadCurriculum() {
    try {
      const response = await getActiveCurriculum();
    ...
    <>
      <section className={`${styles.container} ${styles.hero}`}>
        ...
        <div className={styles.buttons}>
          ...
          <Button type="high" onClick={handleDownloadCurriculum}>
        ...
        <div className={styles.socialMidia}>
          <a href="https://github.com/douglascnunes">
            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.instagram.com/douglasc7nunes/">
            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/douglas-nunes-3b16b9247/">
            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              navigator.clipboard.writeText('douglasc7nunes@gmail.com');
            }}
          >
            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span>douglasc7nunes@gmail.com</span>
          </a>
        </div>
      </section>

      <SectionDivider>Mais sobre mim</SectionDivider>

      <section className={`${styles.container} ${styles.moreAboutMe}`}>
        <p>
          Sou desenvolvedor Fullstack, formado na área de TI, com base em lógica de programação, algoritmos e documentação de processos de software. Atuei por quase dois anos em estágio na área de tecnologia e atualmente trabalho como Auxiliar de TI, com foco na implementação de um ERP web. Agora, busco dar o próximo passo na área com o objetivo de atuar com desenvolvimento de software.
        </p>
        <Resume />
      </section>

      <SectionDivider>Recomendações</SectionDivider>
